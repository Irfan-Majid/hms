    ...
    <div class="col-lg-12">
        <div class="card card-outline-info">
            <div class="card-header">
                <h4 class="m-b-0 text-white">Edit Nurse</h4>
            ...
            @if(Session::has('response'))
                ...
                @endif
            <div class="card-body">
                <form action="{{route(Session::get('identity').'.nurse.update',$nurse->id)}}" method="post" enctype="multipart/form-data">

                    @csrf
                    @method('put')
                    <input type="hidden" value="{{$nurse->user_id}}" name="user_id">
                    <div class="form-body">
                        ...
                        <div class="row p-t-20">
                            <div class="col-md-6">
                                <div class="form-group @if($errors->has('name')) has-danger @endif">
                                    ...
                                    <input type="text" id="name" class="form-control @if($errors->has('name')) form-control-danger @endif" name="name" value="{{$nurse->name}}" placeholder="Full Name">
                                    @if ($errors->has('name'))
                            ...
                            <div class="col-md-6">
                                <div class="form-group @if($errors->has('contact')) has-danger @endif">
                                    ...
                                    <input type="text" id="contact" name="contact" value="{{$nurse->contact}}" class="form-control @if($errors->has('contact')) form-control-danger @endif" placeholder="Contact No">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group @if($errors->has('email')) has-danger @endif">
                                    ...
                                    <input type="email" id="email" name="email" value="{{$nurse->email}}" class="form-control @if($errors->has('email')) form-control-danger @endif" placeholder="Email">
                                    @if ($errors->has('email'))
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group @if($errors->has('address')) has-danger @endif">
                                    ...
                                    <textarea class="form-control @if($errors->has('address')) form-control-danger @endif" id="address" name="address" rows="9">{{$nurse->address}}</textarea>
                            ...
                            <div class="col-md-6">
                                <div class="form-group @if($errors->has('image')) has-danger @endif">
                                    ...
                                    <input type="file" id="input-file-now-custom-3" class="dropify @if($errors->has('image')) form-control-danger @endif" name="image" data-height="220" data-width="220" data-default-file="/{{$nurse->image}}" />
                                    @if ($errors->has('image'))
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group @if($errors->has('e_qualification')) has-danger @endif">
                                    ...
                                    <input type="text" id="e_qualific" value="{{$nurse->e_qualification}}" name="e_qualification" class="form-control @if($errors->has('e_qualification')) form-control-danger @endif">
                            ...
                            <div class="col-md-6">
                                <div class="form-group @if($errors->has('specialization')) has-danger @endif">
                                    ...
                                    <input type="text" id="specialization" value="{{$nurse->specialization}}" name="specialization" class="form-control @if($errors->has('specialization')) form-control-danger @endif">
                            ...
                            <div class="col-md-6">
                                <div class="form-group @if($errors->has('designation')) has-danger @endif">
                                    ...
                                    <select class="form-control custom-select @if($errors->has('designation')) form-control-danger @endif" name="designation">
                                        ...
                                        <option @if(($nurse->designation)=="Professor") selected @endif>Professor</option>
                                        <option @if(($nurse->designation)=="Sr. Nurse") selected @endif>Sr. Nurse</option>
                                        <option @if(($nurse->designation)=="Jr. Nurse") selected @endif>Jr. Nurse</option>
                                        <option @if(($nurse->designation)=="Trainee Nurse") selected @endif>Trainee Nurse</option>
                                    </select>
                                ...
                                <div class="form-group @if($errors->has('department')) has-danger @endif">
                                    ...
                                    <select class="form-control custom-select @if($errors->has('department')) form-control-danger @endif" name="department">
                                        ...
                                        @if($deps)
                                            ...
                                            @foreach($deps as $dep)
                                                <option value="{{$dep->id}}" @if(($dep->id)==($nurse->department_id)) selected @endif>{{$dep->name}}</option>
                                             @endforeach
                                        @endif
