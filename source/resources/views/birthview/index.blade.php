        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Birth REport</h3>
                </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                        <li class="breadcrumb-item"><a href="javascript:void(0)">birth Report</a></li>
...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title clearfix d-flex pull-left">Birth Report List</h4>
                            ...
                            @if($datas)
                                @foreach($datas as $i=>$de)
                                    <tr>
                                        ...
                                        <td>{{$gender[$de->gender]}}</td>
                                        <td>{{$de->birth_date}}</td>
                                        <td>{{$de->description}}</td>
                                        <td class="text-nowrap">
                                            <a href="{{route(Session::get('identity').'.birthreg.show',$de->id)}}" data-toggle="tooltip" data-original-title="show"><i class="mdi mdi-eye text-inverse m-r-10"></i></a>
