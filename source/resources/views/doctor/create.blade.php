    ...
    <div class="col-lg-12">
        <div class="card card-outline-info">
            <div class="card-header">
                <h4 class="m-b-0 text-white">Add Doctor(<small>all field is required</small>)</h4>
            ...
            @if(Session::has('response'))
                ...
                @endif
            <div class="card-body">
                <form action="{{route(Session::get('identity').'.doctor.store')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group @if($errors->has('fee')) has-danger @endif">
                                    ...
                                    <input type="text" id="fee" name="fee" class="form-control @if($errors->has('fee')) form-control-danger @endif">
                                    @if ($errors->has('fee'))
