        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="table-responsive">
                                ...
                                @foreach($datas as $i=>$de)
                                    <tr>
                                        ...
                                        <td class="text-nowrap">
                                            <a href="{{route(Session::get('identity').'.roomtype.edit',$de->id)}}" class="btn waves-effect waves-light btn-rounded btn-xs btn-info">edit</a>
                                            ...
                                            <form action="{{route(Session::get('identity').'.roomtype.destroy',$de->id)}}" method="post" class="d-inline">
                                                @csrf
                                                @method('delete')
                    ...
                    <div>
                        <a href="{{route(Session::get('identity').'.roomtype.create')}}" class="btn btn-info btn-rounded mb-5">Add New Room Type</a>
                    </div>
                </div>
