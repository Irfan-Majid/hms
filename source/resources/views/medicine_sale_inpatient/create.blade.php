...
<div class="row">
    <div class="col-lg-12 h-100 d-flex align-items-stretch">
        <div class="card card-outline-info" Style="min-height: 80vh!important;">
            ...
            <div class="card-body">
                <form method="post" action="{{route(Session::get('identity').'.inmedsale.store')}}">
                    @csrf
                    <div class="row">
                        <div class="col-5">
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 clearfix m-r-30">
                                    <div class="row pt-2 clearfix d-none">
                                        <div class="col-offset-6 row clearfix">
                                            <div class="col-md-6">
                                            <label for="inputAddress" class="col-form-label">Paid Amount </label>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <input type="number" onchange="change_price()" name="pay_amount" class="form-control pay_amount" value="0">
                                        </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 clearfix m-r-30 d-none">
                            ...
                            <div class="hidden-print mt-2 mb-4 m-r-30">
                                <div class="text-right d-print-none">
                                    <button type="submit"class="btn btn-gradient w-20 waves-effect waves-light">Save </button>
                                </div>
                            </div>
                        </div>
                        <div class="row col-7">
