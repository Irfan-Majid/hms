...
<div class="row">
    ...
    <div class="col-lg-4 col-xlg-3 col-md-5">
        <div class="card"> <img class="card-img" src="{{asset('asset/assets/images/background/socialbg.jpg')}}" alt="Card image">
            <div class="card-img-overlay card-inverse social-profile d-flex justify-content-center">
                <div class="align-self-center">
                    <img src="{{asset('')}}{{$doctor->image}}" class="img-circle" width="100">
                    <h4 class="card-title">{{$doctor->name}}</h4>
                    <h6 class="card-subtitle">@ {{$doctor->name}}</h6>
                    <p class="text-white">specialized in {{$doctor->specialization}}</p>
                </div>
            </div>
        </div>
        <div class="card">
            <div class="card-body"> <small class="text-muted">Email address </small>
                ...
                <h6>{{$doctor->contact}}</h6> <small class="text-muted p-t-30 db">Address</small>
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-3 col-xs-6 b-r"> <strong>Mobile</strong>
                                <br>
                                <p class="text-muted">{{$doctor->contact}}</p>
                            </div>
