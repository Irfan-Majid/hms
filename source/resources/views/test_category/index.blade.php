        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Test Category</h3>
                </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Test Category</a></li>
...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Test Category List</h4>
                ...
                <div class="table-responsive">
                                ...
                                @foreach($Categorys as $i=>$Category)
                                    <tr>
                                        ...
                                        <td class="text-nowrap">
                                            <a href="{{route(Session::get('identity').'.testcategory.edit',$Category->id)}}" class="btn waves-effect waves-light btn-rounded btn-xs btn-info">edit</a>
                    ...
                    <div>
                        <a href="{{route(Session::get('identity').'.testcategory.create')}}" class="btn btn-info btn-rounded mb-5">Add New</a>
                    </div>
                </div>
