...
@section('title', 'Outdoor Patient Create')
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Outdoor Patient Create</h3>
                </div>
    ...
    <div class="col-lg-12">
        <div class="card card-outline-info">
            ...
            @if(Session::has('response'))
                ...
                @endif
            <div class="card-body">
                <form action="{{route(Session::get('identity').'.out-patient.store')}}" method="post" enctype="multipart/form-data">
