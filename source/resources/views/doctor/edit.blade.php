    ...
    <div class="col-lg-12">
        <div class="card card-outline-info">
            ...
            @if(Session::has('response'))
                ...
                @endif
            <div class="card-body">
                <form action="{{route(Session::get('identity').'.doctor.update',$doctor->id)}}" method="post" enctype="multipart/form-data">

                    @csrf
                    @method('put')
                    <input type="hidden" value="{{$doctor->user_id}}" name="user_id">
                    <div class="form-body">
                        ...
                        <div class="row p-t-20">
                            <div class="col-md-6">
                                <div class="form-group @if($errors->has('name')) has-danger @endif">
                                    ...
                                    <input type="text" id="name" class="form-control @if($errors->has('name')) form-control-danger @endif" name="name" value="{{$doctor->name}}" placeholder="Full Name">
                                    @if ($errors->has('name'))
                            ...
                            <div class="col-md-6">
                                <div class="form-group @if($errors->has('contact')) has-danger @endif">
                                    ...
                                    <input type="text" id="contact" name="contact" value="{{$doctor->contact}}" class="form-control @if($errors->has('contact')) form-control-danger @endif" placeholder="Contact No">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group @if($errors->has('email')) has-danger @endif">
                                    ...
                                    <input type="email" id="email" name="email" value="{{$doctor->email}}" class="form-control @if($errors->has('email')) form-control-danger @endif" placeholder="Email">
                                    @if ($errors->has('email'))
                            ...
                            <div class="col-md-6">
                                <div class="form-group @if($errors->has('b_date')) has-danger @endif">
                                    ...
                                    <input type="date" id="b_date" name="b_date" value="{{$employee->b_date}}" class="form-control @if($errors->has('b_date')) form-control-danger @endif" placeholder="dd/mm/yyyy">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group @if($errors->has('address')) has-danger @endif">
                                    ...
                                    <textarea class="form-control @if($errors->has('address')) form-control-danger @endif" id="address" name="address" rows="9">{{$doctor->address}}</textarea>
                            ...
                            <div class="col-md-6">
                                <div class="form-group @if($errors->has('image')) has-danger @endif">
                                    ...
                                    <input type="file" id="input-file-now-custom-3" class="dropify @if($errors->has('image')) form-control-danger @endif" name="image" data-height="220" data-width="220" data-default-file='{{asset("$doctor->image")}}' />
                                    @if ($errors->has('image'))
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group @if($errors->has('e_qualification')) has-danger @endif">
                                    ...
                                    <input type="text" id="e_qualific" value="{{$doctor->e_qualification}}" name="e_qualification" class="form-control @if($errors->has('e_qualification')) form-control-danger @endif">
                            ...
                            <div class="col-md-6">
                                <div class="form-group @if($errors->has('specialization')) has-danger @endif">
                                    ...
                                    <input type="text" id="specialization" value="{{$doctor->specialization}}" name="specialization" class="form-control @if($errors->has('specialization')) form-control-danger @endif">
                            ...
                            <div class="col-md-6">
                                <div class="form-group @if($errors->has('designation')) has-danger @endif">
                                    ...
                                    <select class="form-control custom-select @if($errors->has('designation')) form-control-danger @endif" name="designation">
                                        ...
                                        <option @if(($doctor->designation)=="Professor") selected @endif>Professor</option>
                                        <option @if(($doctor->designation)=="Sr. Doctor") selected @endif>Sr. Doctor</option>
                                        <option @if(($doctor->designation)=="Jr. Doctor") selected @endif>Jr. Doctor</option>
                                        <option @if(($doctor->designation)=="Trainee Doctor") selected @endif>Trainee Doctor</option>
                                    </select>
                                ...
                                <div class="form-group @if($errors->has('department')) has-danger @endif">
                                    ...
                                    <select class="form-control custom-select @if($errors->has('department')) form-control-danger @endif" name="department">
                                        ...
                                        @if($deps)
                                            ...
                                            @foreach($deps as $dep)
                                                <option value="{{$dep->id}}" @if(($dep->id)==($doctor->department_id)) selected @endif>{{$dep->name}}</option>
                                             @endforeach
                                        @endif
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group @if($errors->has('fee')) has-danger @endif">
                                    <label for="fee">Fee</label>
                                    <input value="{{$doctor->fee}}" type="text" id="fee" name="fee" class="form-control @if($errors->has('fee')) form-control-danger @endif">
                                    @if ($errors->has('fee'))
                                        <span class="form-control-feedback">{{ $errors->first('fee') }}</span>
                                    @endif
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group @if($errors->has('username')) has-danger @endif">
                                ...
                                <input type="text" id="username" name="username" value="{{$user->username}}"class="form-control @if($errors->has('username')) form-control-danger @endif">
