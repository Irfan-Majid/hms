...
<div class="row">
    <div class="col-lg-12">
        <div class="card card-outline-info">
            ...
            <div class="card-body">
                <form action="{{route(Session::get('identity').'.employee.store')}}" method="post" enctype="multipart/form-data">                       
                    @csrf
                    <div class="form-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group @if($errors->has('designation')) has-danger @endif">
                                    ...
                                    <input type="text" id="designation" name="designation" class="form-control @if($errors->has('designation')) form-control-danger @endif">
