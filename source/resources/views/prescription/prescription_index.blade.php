										...
										<div>
											<table id="myTable" class="table table-striped table-bordered table-hover">
												...
												@forelse($list as $l)
													<tr>
														<td>{{$i++}}</td>
														<td>{{$l->appointment_func?->patient_id}}</td>
														<td>{{$l->appointment_func?->employ_basic->first_name.' '.$l->appointment_func->employ_basic->last_name}}</td>
														<td>{{$l->appointment_func?->doctor?->department?->dep_name}}</td>
