        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Medicine Generic</h3>
                </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Medicine Generic</a></li>
...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Medecine Generic List</h4>
                ...
                <div class="table-responsive">
                    <table class="table color-table muted-table">
                                ...
                                @foreach($gen as $i=>$de)
                                    <tr>
                                        ...
                                        <td class="text-nowrap">
                                            <a href="{{route(Session::get('identity').'.medicinegeneric.edit',$de->id)}}" class="btn waves-effect waves-light btn-rounded btn-xs btn-info">edit</a>
                                            ...
                                            <form action="{{route(Session::get('identity').'.medicinegeneric.destroy',$de->id)}}" method="post" class="d-inline">
                                                @csrf
                                                @method('delete')
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <td colspan="7">
                                    {{ $gen->links('pagination::bootstrap-4') }}
                    ...
                    <div>
                        <a href="{{route(Session::get('identity').'.medicinegeneric.create')}}" class="btn btn-info btn-rounded mb-5">Add New Generic</a>
                    </div>
                </div>
