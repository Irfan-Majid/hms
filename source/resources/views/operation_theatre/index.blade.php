        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="table-responsive">
                                ...
                                @foreach($ots as $i=>$de)
                                    <tr>
                                        ...
                                        <td class="text-nowrap">
                                            <a href="{{route(Session::get('identity').'.o_theatre.edit',$de->id)}}" class="btn waves-effect waves-light btn-rounded btn-xs btn-info">edit</a>
                                            ...
                                            <form action="{{route(Session::get('identity').'.o_theatre.destroy',$de->id)}}" method="post" class="d-inline">
                                                @csrf
                                                @method('delete')
                    ...
                    <div>
                        <a href="{{route(Session::get('identity').'.o_theatre.create')}}" class="btn btn-info btn-rounded mb-5">Add New Department</a>
                    </div>
                </div>
