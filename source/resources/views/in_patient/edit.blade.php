...
@section('title', 'Admitted Patient Edit')
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Admitted Patient Edit</h3>
                </div>
    ...
    <div class="col-lg-12">
        <div class="card card-outline-info">
            <div class="card-header">
                <h4 class="m-b-0 text-white">Edit Patient(<small>all field is required<small>)</h4>
            ...
            @if(Session::has('response'))
                ...
                @endif
            <div class="card-body">
                <form action="{{route(Session::get('identity').'.in-patient.update',$inPatient->id)}}" method="post" enctype="multipart/form-data">

                    @csrf
                    @method('put')
                    <input type="hidden" value="{{$inPatient->user_id}}" name="user_id">
                    <div class="form-body">
                        ...
                        <div class="row p-t-20">
                            <div class="col-md-6">
                                <div class="form-group @if($errors->has('name')) has-danger @endif">
                                    ...
                                    <input type="text" id="name" value="{{$inPatient->name}}" class="form-control @if($errors->has('name')) form-control-danger @endif" name="name" placeholder="Full Name">
                                    @if ($errors->has('name'))
                            ...
                            <div class="col-md-6">
                                <div class="form-group @if($errors->has('contact')) has-danger @endif">
                                    ...
                                    <input type="text" id="contact" value="{{$inPatient->contact}}" name="contact" class="form-control @if($errors->has('contact')) form-control-danger @endif" placeholder="Contact No">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group @if($errors->has('email')) has-danger @endif">
                                    ...
                                    <input type="email" id="email" value="{{$inPatient->email}}" name="email" class="form-control @if($errors->has('email')) form-control-danger @endif" placeholder="Email">
                                    @if ($errors->has('email'))
                            ...
                            <div class="col-md-6">
                                <div class="form-group @if($errors->has('b_date')) has-danger @endif">
                                    ...
                                    <input type="date" id="b_date" value="{{$inPatient->b_date}}" name="b_date" class="form-control @if($errors->has('b_date')) form-control-danger @endif" placeholder="dd/mm/yyyy">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group @if($errors->has('address')) has-danger @endif">
                                    ...
                                    <textarea class="form-control @if($errors->has('address')) form-control-danger @endif" id="address" name="address" rows="9">{{$inPatient->address}}</textarea>
                            ...
                            <div class="col-md-6">
                                <div class="form-group @if($errors->has('image')) has-danger @endif">
                                    ...
                                    <input type="file" id="input-file-now-custom-3" class="dropify @if($errors->has('image')) form-control-danger @endif" name="image" data-height="220" data-width="220" data-default-file="/{{$inPatient->image}}" />
                                    @if ($errors->has('image'))
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group @if($errors->has('c_casuelty')) has-danger @endif">
                                    ...
                                    <input type="text" id="e_qualific" name="c_casuelty" value="{{$inPatient->core_casualty}}" class="form-control @if($errors->has('c_casuelty')) form-control-danger @endif">
                            ...
                            <div class="col-md-6">
                                <div class="form-group @if($errors->has('blood')) has-danger @endif">
                                    ...
                                    <input type="text" id="specialization" name="blood" value="{{$inPatient->blood}}" class="form-control @if($errors->has('blood')) form-control-danger @endif">
                                    @if ($errors->has('blood'))
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group @if($errors->has('height')) has-danger @endif">
                                    ...
                                    <input type="text" id="e_qualific" name="height" value="{{$inPatient->height}}" class="form-control @if($errors->has('height')) form-control-danger @endif">
                            ...
                            <div class="col-md-6">
                                <div class="form-group @if($errors->has('weight')) has-danger @endif">
                                    ...
                                    <input type="text" id="specialization" name="weight" value="{{$inPatient->weight}}" class="form-control @if($errors->has('weight')) form-control-danger @endif">
                                    ...
                                    <select class="form-control custom-select @if($errors->has('room')) form-control-danger @endif" name="room">
                                        ...
                                        @if($rooms)
                                            ...
                                            @foreach($rooms as $room)
                                                <option value="{{$room->id}}" @if(($inPatient->room_id)==($room->id))selected @endif>{{$room->room_no}}</option>
                                            @endforeach
                                        @endif
                                    ...
                                    <select class="form-control custom-select @if($errors->has('doctor')) form-control-danger @endif" name="doctor">
                                        ...
                                        @if($doctors)
                                            ...
                                            @foreach($doctors as $doc)
                                                <option value="{{$doc->id}}" @if(($inPatient->referred_by)==($doc->id)) selected @endif>{{$doc->name}}</option>
                                            @endforeach
                                        @endif
