                ...
                <div class="single-testimonial text-center">
                    ...
                    <div class="testimonial-caption ">
                        <div class="testimonial-top-cap">
                            <img src="asset/site_assets/img/gallery/testimonial.png" alt="">
    ...
    <!-- Gallery Area End -->
     ...
     <div class="contact-form-main">
        ...
        <div class="from-left d-none d-lg-block">
            <img src="asset/site_assets/img/gallery/contact_form.png" alt="">
        </div>
    </div>
    <!-- Contact form End -->
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-">
                    <div class="single-team mb-30">
                        <div class="team-img">
                            <img src="asset/site_assets/img/gallery/team1.png" alt="">
                        </div>
                        <div class="team-caption">
