    ...
    <div class="col-lg-12">
        <div class="card card-outline-info">
            <div class="card-header">
                <h4 class="m-b-0 text-white">Add Appointment SChedule</h4>
            ...
            @if(Session::has('response'))
                ...
                @endif
            <div class="card-body">
                <form action="{{route(Session::get('identity').'.doctorschedule.store')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-md-12">
                                <div class="form-group ">
                                    ...
                                    <select class="form-control custom-select " name="doctor_id">
                                        <option><center>--Select Doctor--</center></option>
                                        @if($doctors)
                            ...
                            <div class="col-md-6">
                                <div class="form-group ">
                                    ...
                                    <select class="form-control custom-select " name="dutyshift_id">
                                        ...
                                        <option value="{{$dutyshift->id}}">{{$dutyshift->name}} [{{$dutyshift->start_time}} -- {{$dutyshift->end_time}} ]</option>
                                        @endforeach
                                    @endif
                                    </select>
                                </div>
