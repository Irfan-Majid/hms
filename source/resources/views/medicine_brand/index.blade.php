        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Medicine Brand</h3>
                </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Medecine Brand</a></li>
...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Medecine Brand List</h4>
                ...
                <div class="table-responsive">
                    <table class="table color-table muted-table">
                        ...
                        <tbody>
                            @if($brand)
                                @foreach($brand as $i=>$de)
                                    <tr>
                                        <td>{{++$i}}</td>
                                        <td>{{$de->name}}</td>
                                        <td class="text-nowrap">
                                            <a href="{{route(Session::get('identity').'.medicinebrand.edit',$de->id)}}" class="btn waves-effect waves-light btn-rounded btn-xs btn-info">edit</a>
                                            ...
                                            <form action="{{route(Session::get('identity').'.medicinebrand.destroy',$de->id)}}" method="post" class="d-inline">
                                                @csrf
                                                @method('delete')
                    ...
                    <div>
                        <a href="{{route(Session::get('identity').'.medicinebrand.create')}}" class="btn btn-info btn-rounded mb-5">Add New</a>
                    </div>
                </div>
