...
<div class="row">
    <div class="col-lg-12">
        <div class="card card-outline-info">
            ...
            <div class="card-body">
                <form action="{{route(Session::get('identity').'.ot_type.store')}}" method="post" class="form-horizontal form-bordered">
                    @csrf
                    <div class="form-body">
                        ...
                        <div class="form-group row @if($errors->has('description')) has-danger @endif">
                            ...
                            <div class="col-md-9">
                                <input type="text" placeholder="description" name="description" class="form-control @if($errors->has('description')) form-control-danger @endif">
                        ...
                        <div class="form-group row @if($errors->has('price')) has-danger @endif">
                            ...
                            <div class="col-md-9">
                                <input type="text" placeholder="price" name="price" class="form-control @if($errors->has('price')) form-control-danger @endif">
                                @if ($errors->has('price'))
                        ...
                        <div class="form-group row @if($errors->has('note')) has-danger @endif">
                            ...
                            <div class="col-md-9">
                                <input type="text" placeholder="note" name="note" class="form-control @if($errors->has('note')) form-control-danger @endif">
                                @if ($errors->has('note'))
