...
<div class="row">
    <div class="col-lg-12">
        <div class="card card-outline-info">
            ...
            <div class="card-body">
                <form action="{{route(Session::get('identity').'.employee.update',$employee->id)}}" method="post" enctype="multipart/form-data">                        
                    @csrf
                    @method('put')
                        ...
                        <div class="row p-t-20">
                            <div class="col-md-6">
                                <div class="form-group @if($errors->has('name')) has-danger @endif">
                                    ...
                                    <input type="text" value="{{$employee->name}}" id="name" class="form-control @if($errors->has('name')) form-control-danger @endif" name="name" placeholder="Full Name">
                                    @if ($errors->has('name'))
                            ...
                            <div class="col-md-6">
                                <div class="form-group @if($errors->has('contact')) has-danger @endif">
                                    ...
                                    <input type="text" value="{{$employee->contact}}" id="contact" name="contact" class="form-control @if($errors->has('contact')) form-control-danger @endif" placeholder="Contact No">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group @if($errors->has('email')) has-danger @endif">
                                    ...
                                    <input type="email" value="{{$employee->email}}" id="email" name="email" class="form-control @if($errors->has('email')) form-control-danger @endif" placeholder="Email">
                                    @if ($errors->has('email'))
                            ...
                            <div class="col-md-6">
                                <div class="form-group @if($errors->has('b_date')) has-danger @endif">
                                    ...
                                    <input type="date" value="{{$employee->b_date}}" id="b_date" name="b_date" class="form-control @if($errors->has('b_date')) form-control-danger @endif" placeholder="dd/mm/yyyy">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group @if($errors->has('address')) has-danger @endif">
                                    ...
                                    <textarea class="form-control @if($errors->has('address')) form-control-danger @endif" id="address" name="address" rows="9">{{$employee->address}}</textarea>
                            ...
                            <div class="col-md-6">
                                <div class="form-group @if($errors->has('image')) has-danger @endif">
                                    ...
                                    <input type="file" id="input-file-now-custom-3" class="dropify @if($errors->has('image')) form-control-danger @endif" name="image" data-height="220" data-width="220" data-default-file="/{{$employee->image}}" />
                                    @if ($errors->has('image'))
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group @if($errors->has('e_qualification')) has-danger @endif">
                                    ...
                                    <input type="text" value="{{$employee->e_qualification}}" id="e_qualific" name="e_qualification" class="form-control @if($errors->has('e_qualification')) form-control-danger @endif">
                            ...
                            <div class="col-md-6">
                                <div class="form-group @if($errors->has('designation')) has-danger @endif">
                                    ...
                                    <input type="text" id="designation" value="{{$employee->designation}}" name="designation" class="form-control @if($errors->has('designation')) form-control-danger @endif">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group @if($errors->has('username')) has-danger @endif">
                                ...
                                <input type="text" id="username" value="{{$user->username}}" name="username" class="form-control @if($errors->has('username')) form-control-danger @endif">
