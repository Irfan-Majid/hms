        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Edit Room</h3>
                </div>
    ...
    <div class="col-lg-12">
        <div class="card card-outline-info">
            ...
            <div class="card-header">
                <h4 class="m-b-0 text-white">Edit Room here(<small>all field must not empty</small>)</h4>
            </div>
            <div class="card-body">
                <form action="{{route(Session::get('identity').'.room.update',$room->id)}}" method="post" class="form-horizontal form-bordered">
                    @csrf
                    @method('put')
                    <input type="hidden" name="id" value="{{$room->id}}">
                    <div class="form-body">
                        <div class="form-group row @if($errors->has('room_no')) has-danger @endif">
                            <label class="control-label text-right col-md-3">Room Number</label>
                            <div class="col-md-9">
                                <input type="text" placeholder="Department Name" name="room_no" value="{{$room->room_no}}" class="form-control @if($errors->has('room_no')) form-control-danger @endif">
                        ...
                        <div class="form-group row @if($errors->has('room_type')) has-danger @endif">
                            ...
                            <div class="col-md-9">
                                <select class="form-control @if($errors->has('room_type')) form-control-danger @endif custom-select" placeholder="Room Type" name="room_type">
                                    ...
                                    <option value="{{$item->id}}" @if($item->id==$room->roomtype_id) selected @endif>{{$item->name}}</option>    
                                    @endforeach
                                </select>
