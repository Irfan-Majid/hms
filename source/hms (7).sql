...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 18, 2021 at 08:46 PM
...
CREATE TABLE `appointements` (
  ...
  `out_patient_id` bigint(20) UNSIGNED DEFAULT NULL,
  `doctor_id` bigint(20) UNSIGNED DEFAULT NULL,
  `appoint_date` date NOT NULL,
  `serial` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `problem` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `approved` int(11) NOT NULL DEFAULT 1 COMMENT '1=>approved,2=>not_approved',
  `status` int(11) NOT NULL DEFAULT 1 COMMENT '0=>prescribed,1=>not prescribed',
...
INSERT INTO `appointements` (`id`, `out_patient_id`, `doctor_id`, `appoint_date`, `serial`, `problem`, `approved`, `status`, `created_by`, `updated_by`, `deleted_at`, `created_at`, `updated_at`) VALUES
(1, 2, 14, '2021-12-20', '1', 'asasasa', 1, 1, 2, 2, NULL, '2021-12-15 09:48:44', '2021-12-15 09:48:44'),
(2, 2, 14, '2021-12-20', '2', 'asas', 1, 1, 2, 2, NULL, '2021-12-15 09:49:32', '2021-12-15 09:49:32'),
(3, 2, 14, '2021-12-20', '3', 'asas', 1, 0, 2, 2, NULL, '2021-12-15 09:52:15', '2021-12-16 08:00:09');
...
INSERT INTO `doctors` (`id`, `name`, `specialization`, `e_qualification`, `designation`, `fee`, `contact`, `email`, `address`, `status`, `image`, `department_id`, `employee_id`, `user_id`, `deleted_at`, `created_at`, `updated_at`) VALUES
(11, 'Emran', 'ENT', 'mbbs', 'Professor', 500, '12', 'emran@gmail.com', 'emran address', 1, 'images/1638423231.jpg', 13, 14, 28, NULL, '2021-12-01 23:33:51', '2021-12-02 00:22:40'),
(12, 'sakib', 'Eye', 'mbbs', 'Sr. Doctor', 500, '123456', 'sakib_doctor@gmail.com', 'sakibaddress', 1, 'images/1638426324.png', 9, 16, 30, NULL, '2021-12-02 00:25:24', '2021-12-02 00:25:51'),
(13, 'raihan', 'Child', 'mbbs', 'Professor', 600, '1234567', 'raihan@gmail.com', 'raihan address', 1, 'images/1638426412.jpg', 9, 17, 31, NULL, '2021-12-02 00:26:52', '2021-12-02 00:33:31'),
(14, 'Asma Akterr', 'no jani2', 'bekar2', 'Professor', 700, '01326566562', 'irfanvai.ctg@gmail.com', 'Kazir Dewri', 1, 'images/1638468962.png', 9, 18, 33, NULL, '2021-12-02 12:16:02', '2021-12-06 09:28:07'),
(15, 'nm', 'nm', 'nm', 'Sr. Doctor', NULL, 'nm', 'nm@nm.com', 'nm', 1, 'source/public/images/1639722853.jpg', 9, 22, 38, NULL, '2021-12-17 00:34:13', '2021-12-17 00:34:13');
...
(21, 'mn', 'mn', 'mn', 'mn@mn.com', 'images/1639722570.jpg', '2021-12-17 06:29:30', 'Professor', 'mn', '2021-12-24', 1, 37, NULL, '2021-12-17 00:29:30', '2021-12-17 00:29:30'),
(22, 'nm', 'nm', 'nm', 'nm@nm.com', 'images/1639722853.jpg', '2021-12-17 06:34:13', 'Sr. Doctor', 'nm', '2021-12-21', 1, 38, NULL, '2021-12-17 00:34:13', '2021-12-17 00:34:13');
...
(33, '2021_12_11_183428_create_appointements_table', 8),
(36, '2021_12_16_114013_create_prescriptions_table', 9),
(37, '2021_12_16_114136_create_prescribmedicines_table', 9),
(39, '2021_12_17_105315_create_testcategories_table', 10),
(40, '2021_12_17_105640_create_testnames_table', 10),
(43, '2021_12_18_064746_create_patienttests_table', 11),
(44, '2021_12_18_064847_create_patienttestdetails_table', 11);
...
(2, 'PA-OUT-12345', 'Asma Akter', '0132656656221', 'tryaaaa@email.com', 'Kazir Dewri', 'as', '2021-12-28', 'as', 'as', 'as', 'images/1638471139.png', 34, NULL, '2021-12-02 12:52:19', '2021-12-02 12:52:19');
...
--
-- Table structure for table `patienttestdetails`
--

CREATE TABLE `patienttestdetails` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `patienttest_id` bigint(20) UNSIGNED NOT NULL,
  `testname_id` bigint(20) UNSIGNED NOT NULL,
...
--
-- Dumping data for table `patienttestdetails`
--

INSERT INTO `patienttestdetails` (`id`, `patienttest_id`, `testname_id`, `status`, `deleted_at`, `created_at`, `updated_at`) VALUES
(1, 1, 1, 1, NULL, '2021-12-18 10:34:16', '2021-12-18 10:34:16'),
(2, 1, 2, 1, NULL, '2021-12-18 10:34:16', '2021-12-18 10:34:16');
...
CREATE TABLE `patienttests` (
  ...
  `out_patient_id` bigint(20) UNSIGNED DEFAULT NULL,
  `doctor_id` bigint(20) UNSIGNED DEFAULT NULL,
  `vat` double(8,2) NOT NULL COMMENT 'this is a % value',
  `discount` double(8,2) NOT NULL COMMENT 'this is a % value',
...
INSERT INTO `patienttests` (`id`, `out_patient_id`, `doctor_id`, `vat`, `discount`, `grand_total`, `paid`, `status`, `created_by`, `updated_by`, `deleted_at`, `created_at`, `updated_at`) VALUES
(1, 2, NULL, 10.00, 15.00, 209.00, 209.00, 0, 2, 2, NULL, '2021-12-18 10:34:16', '2021-12-18 13:36:46');
...
--
-- Table structure for table `prescribmedicines`
--

CREATE TABLE `prescribmedicines` (
  `id` bigint(20) UNSIGNED NOT NULL,
  ...
  `medicine_note` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `medicine_duration` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` int(11) NOT NULL DEFAULT 1,
  `created_by` int(11) NOT NULL,
  `updated_by` int(11) NOT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
...
--
-- Dumping data for table `prescribmedicines`
--

INSERT INTO `prescribmedicines` (`id`, `prescription_id`, `medicine_name`, `medicine_type`, `medicine_dose`, `medicine_note`, `medicine_duration`, `status`, `created_by`, `updated_by`, `deleted_at`, `created_at`, `updated_at`) VALUES
(1, 2, 'a1', 'a2', 'a3', '2', 'a4', 1, 2, 2, NULL, '2021-12-16 08:00:09', '2021-12-16 08:00:09'),
(2, 2, 'b1', 'b2', 'b3', '1', 'b4', 1, 2, 2, NULL, '2021-12-16 08:00:09', '2021-12-16 08:00:09');
...
CREATE TABLE `prescriptions` (
  ...
  `appointement_id` bigint(20) UNSIGNED NOT NULL,
  `advice` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `nxt_visit` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` int(11) NOT NULL DEFAULT 1,
...
INSERT INTO `prescriptions` (`id`, `cc`, `investigation`, `appointement_id`, `advice`, `nxt_visit`, `status`, `note`, `created_by`, `updated_by`, `deleted_at`, `created_at`, `updated_at`) VALUES
(2, 'cc', 'inv', 3, 'adv', '365', 1, NULL, 2, 2, NULL, '2021-12-16 08:00:09', '2021-12-16 08:00:09');
...
INSERT INTO `testcategories` (`id`, `name`, `description`, `status`, `created_by`, `updated_by`, `deleted_at`, `created_at`, `updated_at`) VALUES
(1, 'aa', 'bb', 1, NULL, NULL, NULL, '2021-12-17 06:56:01', '2021-12-17 07:19:00'),
(2, 'X-ray', 'for Xray', 1, NULL, NULL, NULL, '2021-12-17 07:19:56', '2021-12-17 07:19:56'),
(3, 'Blood', 'for blood', 1, NULL, NULL, NULL, '2021-12-17 07:20:09', '2021-12-17 07:20:09');
...
CREATE TABLE `testnames` (
  ...
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `description` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `testcategory_id` bigint(20) UNSIGNED NOT NULL,
...
INSERT INTO `testnames` (`id`, `name`, `description`, `testcategory_id`, `price`, `status`, `created_by`, `updated_by`, `deleted_at`, `created_at`, `updated_at`) VALUES
(1, 'Irfan', 'b', 1, 20, 1, NULL, NULL, NULL, '2021-12-17 07:58:18', '2021-12-17 07:58:18'),
(2, 'irfan_help.txt', 'bb', 2, 200, 1, NULL, NULL, NULL, '2021-12-17 08:01:14', '2021-12-17 08:01:14');
...
(37, 'mn', 'mn', 'mn@mn.com', 'mn', 'images/1639722570.jpg', 1, 3, NULL, '610e4a2656edd121a409f8d6bff87f515f0ddf80', NULL, NULL, '2021-12-17 00:29:30', '2021-12-17 00:29:30'),
(38, 'nm', 'nm', 'nm@nm.com', 'nm', 'source/public/images/1639722853.jpg', 1, 3, NULL, '561baf324bc39db15408f24078012251c0efda39', NULL, NULL, '2021-12-17 00:34:13', '2021-12-17 00:34:13');
...
ALTER TABLE `appointements`
  ADD PRIMARY KEY (`id`),
  ADD KEY `appointements_out_patient_id_foreign` (`out_patient_id`),
...
--
-- Indexes for table `patienttestdetails`
--
ALTER TABLE `patienttestdetails`
  ADD PRIMARY KEY (`id`),
  ADD KEY `patienttestdetails_patienttest_id_foreign` (`patienttest_id`),
  ADD KEY `patienttestdetails_testname_id_foreign` (`testname_id`);
...
ALTER TABLE `patienttests`
  ADD PRIMARY KEY (`id`),
  ADD KEY `patienttests_out_patient_id_foreign` (`out_patient_id`),
  ADD KEY `patienttests_doctor_id_foreign` (`doctor_id`);
...
--
-- Indexes for table `prescribmedicines`
--
ALTER TABLE `prescribmedicines`
  ADD PRIMARY KEY (`id`),
  ADD KEY `prescribmedicines_prescription_id_foreign` (`prescription_id`);
...
ALTER TABLE `prescriptions`
  ADD PRIMARY KEY (`id`),
  ADD KEY `prescriptions_appointement_id_foreign` (`appointement_id`);
...
ALTER TABLE `testnames`
  ADD PRIMARY KEY (`id`),
  ADD KEY `testnames_testcategory_id_foreign` (`testcategory_id`);
...
--
-- AUTO_INCREMENT for table `patienttestdetails`
--
ALTER TABLE `patienttestdetails`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
-- AUTO_INCREMENT for table `prescribmedicines`
--
ALTER TABLE `prescribmedicines`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
ALTER TABLE `appointements`
  ...
  ADD CONSTRAINT `appointements_out_patient_id_foreign` FOREIGN KEY (`out_patient_id`) REFERENCES `out_patients` (`id`) ON DELETE CASCADE;
...
--
-- Constraints for table `patienttestdetails`
--
ALTER TABLE `patienttestdetails`
  ADD CONSTRAINT `patienttestdetails_patienttest_id_foreign` FOREIGN KEY (`patienttest_id`) REFERENCES `patienttests` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `patienttestdetails_testname_id_foreign` FOREIGN KEY (`testname_id`) REFERENCES `testnames` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `patienttests`
--
ALTER TABLE `patienttests`
  ADD CONSTRAINT `patienttests_doctor_id_foreign` FOREIGN KEY (`doctor_id`) REFERENCES `doctors` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `patienttests_out_patient_id_foreign` FOREIGN KEY (`out_patient_id`) REFERENCES `out_patients` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `prescribmedicines`
--
ALTER TABLE `prescribmedicines`
  ADD CONSTRAINT `prescribmedicines_prescription_id_foreign` FOREIGN KEY (`prescription_id`) REFERENCES `prescriptions` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `prescriptions`
--
ALTER TABLE `prescriptions`
  ADD CONSTRAINT `prescriptions_appointement_id_foreign` FOREIGN KEY (`appointement_id`) REFERENCES `appointements` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `testnames`
--
ALTER TABLE `testnames`
  ADD CONSTRAINT `testnames_testcategory_id_foreign` FOREIGN KEY (`testcategory_id`) REFERENCES `testcategories` (`id`) ON DELETE CASCADE;
