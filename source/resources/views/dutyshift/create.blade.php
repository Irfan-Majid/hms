...
<div class="row">
    <div class="col-lg-12">
        <div class="card card-outline-info">
            ...
            <div class="card-body">
                <form action="{{route(Session::get('identity').'.dutyshift.store')}}" method="post" enctype="multipart/form-data">                       
                    @csrf
                    <div class="form-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="input-group clockpicker  @if($errors->has('start_time')) has-danger @endif">
                                    <input type="text" class="form-control @if($errors->has('start_time')) form-control-danger @endif" name="start_time" placeholder="22:30"> <span class="input-group-addon pt-1"> <span class="fa fa-clock-o"></span> </span>
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group clockpicker @if($errors->has('end_time')) has-danger @endif">
                                    <input type="text" name="end_time" class="form-control @if($errors->has('end_time')) form-control-danger @endif" placeholder="23:30"> <span class="input-group-addon pt-1"> <span class="fa fa-clock-o"></span> </span>
                                </div>
