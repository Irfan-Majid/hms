...
<div class="row">
    <div class="col-lg-12">
        <div class="card card-outline-info">
            ...
            <div class="card-body">
                <form action="{{route(Session::get('identity').'.birthreg.store')}}" class="form-horizontal" method="post">
                    @csrf
                    <div class="form-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group row">
                                <label class="control-label text-right col-md-2">Child title</label>
                                <div class="col-md-10">
                                    <input type="text" autocomplete="off" name="child_title" class="form-control" placeholder="Child Title">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <!--/span-->
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                    <div class="icheck-list p-t-0 m-t-0">
                                        <input type="radio" value="1" checked class="check" name="gender" data-radio="iradio_line-green" data-label="Male">
                                        &nbsp;
                                        <input type="radio" value="2" class="check" {{Request::old('approve') == '0' ? 'checked' : ''}} name="gender" data-radio="iradio_line-green" data-label="Female">
                                    </div>
                                    </div>
