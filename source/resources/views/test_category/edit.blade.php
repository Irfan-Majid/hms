...
<div class="row">
    <div class="col-lg-12">
        <div class="card card-outline-info">
            ...
            <div class="card-body">
                <form action="{{route(Session::get('identity').'.testcategory.update',$category->id)}}" method="post" class="form-horizontal form-bordered">
                    @csrf
                    @method('put')
                    ...
                    <div class="form-body">
                        <div class="form-group row @if($errors->has('name')) has-danger @endif">
                            ...
                            <div class="col-md-9">
                                <input type="text" placeholder="Department Name" name="name" value="{{$category->name}}" class="form-control @if($errors->has('name')) form-control-danger @endif">
                                @if ($errors->has('name'))
                        ...
                        <div class="form-group row @if($errors->has('description')) has-danger @endif">
                            ...
                            <div class="col-md-9">
                                <input type="text" placeholder="Department description" name="description" value="{{$category->description}}" class="form-control @if($errors->has('description')) form-control-danger @endif">
