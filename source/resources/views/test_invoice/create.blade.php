        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Test Invoice List</h3>
                </div>
...
<div class="row">
    <div class="col-lg-12">
        <div class="card card-outline-info">
            ...
            <div class="card-body">
                <form action="{{route(Session::get('identity').'.testinvoice.store')}}" class="form-horizontal" method="post">
                    @csrf
                    <div class="form-body">
            ...
            $.ajax({
                ...
                .done(function(data) {
                    ...
                    $('#result li').click(function() {
                        ...
                        $.ajax({
                            type        : "GET",
                            url         : "{{route(Session::get('identity').'.findpatientsugdet')}}",
                            data        : formData
                        }).done(function(data) {
