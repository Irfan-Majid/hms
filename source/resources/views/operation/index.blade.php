        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Operation</h3>
                </div>
...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title clearfix d-flex pull-left">Operation List</h4>
                
                <div class="d-flex pull-right">
                    <a href="{{route(Session::get('identity').'.operation.create')}}" class="btn btn-info btn-rounded mb-5">Add New</a>
                </div>
              ...
              <tbody>@php $status=array('Suspended','Active','Retired'); @endphp
                            @if($op)
                                @foreach($op as $i=>$de)
                                    <tr>
                                        ...
                                        <td>{{$de->operationtime?->start_time}}</td>
                                        <td>{{$de->doctor->name}}</td>
                                        <td>{{$de->operationtheatre?->name}}</td>
                                        <td>{{$de->operationtype?->name }}</td>
                                        <td>{{$de->operation_date}}</td>
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <td colspan="7">
                                    {{ $op->links('pagination::bootstrap-4') }}
                                </td>
                            </tr>
                        </tfoot>
                    </table>
