        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Medicine sale</h3>
                </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Medicine Sale</a></li>
...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Medicine Sale List</h4>
                ...
                <div class="table-responsive">
                                ...
                                @foreach($sale as $i=>$de)
                                    <tr>
                                        ...
                                        <td class="text-nowrap">
                                            @if($de->status == 1) 
                                            <a href="{{route(Session::get('identity').'.medsale.edit',$de->id)}}" class="btn waves-effect waves-light btn-rounded btn-xs btn-info">pay due</a>
                                            @endif
                                        </td>
                                    </tr>
                                @endforeach
                    ...
                    <div>
                        <a href="{{route(Session::get('identity').'.medsale.create')}}" class="btn btn-info btn-rounded mb-5">Add New</a>
                    </div>
                </div>
